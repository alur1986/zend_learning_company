...
class MobileNumberExists extends AbstractValidator
{
    ...
    protected $messageTemplates = [
        self::ERROR_EXISTS => 'Mobile number "%value%" is already in use.'
    ];
    ...
    public function isValid ($value, $context = null)
    {
        ...
        // find if another learner already used the same mobile number
        $learner = $service->findDuplicateMobileNumber($mobileNumber, $userId, $siteId);
        if ($learner) {
