...
class EmailAddressExists extends AbstractValidator
{
    ...
    protected $messageTemplates = [
        self::ERROR_EXISTS => 'Email address "%value%" is already in use.'
    ];
    ...
    public function isValid ($value, $context = null)
    {
        ...
        // find if another learner already used the same email address
        $employment = $service->findDuplicateEmail($email, $userId, $siteId);
        if ($employment) {
