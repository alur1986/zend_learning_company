...
use Report\MyLocker\InputFilter\TemplateInputFilter as InputFilter;
use Report\MyLocker\Hydrator\AggregateHydrator as Hydrator;
use Report\MyLocker\Form\TemplateForm as Form;
        ...
        FactoryInterface
{
    ...
    public function createService (ServiceLocatorInterface $serviceLocator)
    {
        ...
        $columns = $options['mylocker']['available_template_columns'];
        $valueOptions = [];
        ...
        // set default value
        $form->get('title')
            ->setValue('MyLocker Report Template');
