...
class TemplateController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\MyLocker\Form\TemplateCreate');
        ...
        //        $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/mylocker/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\MyLocker\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            try {
                ...
                return $this->redirect()->toRoute('report/mylocker/template/directory');
            }
            catch (\Exception $e) {
                // failed
