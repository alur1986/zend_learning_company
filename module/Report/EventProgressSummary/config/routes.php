            ...
            'report' => [
                'child_routes' => [
                    'event-progress-summary' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/event-progress-summary',
                            'defaults' => [
                                'controller' => 'Report\EventProgressSummary\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\EventProgressSummary\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\EventProgressSummary\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
