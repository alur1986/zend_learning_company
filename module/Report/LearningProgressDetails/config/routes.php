            ...
            'report' => [
                'child_routes' => [
                    'learning-progress-details' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/learning-progress-details',
                            'defaults' => [
                                'controller' => 'Report\LearningProgressDetails\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\LearningProgressDetails\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\LearningProgressDetails\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
