            ...
            'report' => [
                'child_routes' => [
                    'individual-locker' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/individual-locker',
                            'defaults' => [
                                'controller' => 'Report\IndividualLocker\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\IndividualLocker\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\IndividualLocker\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
