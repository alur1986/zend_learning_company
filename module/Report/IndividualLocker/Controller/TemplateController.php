...
class TemplateController extends AbstractActionController
{
    ...
    public function directoryAction ()
    {
        ...
        if (isset(equest()->getCookie()->deleteTemplateError)) {
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\IndividualLocker\Form\TemplateCreate');
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                $data['type'] = 'report-individual-locker';
        ...
        //        $cookie = new SetCookie('newTemplate', $template['title'], time() + 60 * 1, '/');
         //       $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/individual-locker/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\IndividualLocker\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            try {
                ...
                return $this->redirect()->toRoute('report/individual-locker/template/directory');
            }
            catch (\Exception $e) {
                // failed
