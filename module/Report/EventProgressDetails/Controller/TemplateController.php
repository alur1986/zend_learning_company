...
class TemplateController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\EventProgressDetails\Form\TemplateCreate');
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                $data['type'] = 'report-event-progress-details';
       ...
       //         $cookie = new SetCookie('newTemplate', $template['title'], time() + 60 * 1, '/');
        //        $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/event-progress-details/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\EventProgressDetails\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            try {
                ...
                return $this->redirect()->toRoute('report/event-progress-details/template/directory');
            }
            catch (\Exception $e) {
                // failed
