...
return [
    'report' => [
        'event-progress-details' => [
            'templates' => [
                'default' => [
                    'title' => 'Event Progress Details Report Default Template',
                    'description' => 'Default template for the Event Progress Details Report',
                    'config' => [
			...
			'available_template_columns' => [
				[ 'title' => 'Event Title', 'key' => 'event_title' ],
				[ 'title' => 'Event Start Date', 'key' => 'event_start_date' ],
				[ 'title' => 'Event End Date', 'key' => 'event_end_date' ],
