            ...
            'report' => [
                'child_routes' => [
                    'event-progress-details' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/event-progress-details',
                            'defaults' => [
                                'controller' => 'Report\EventProgressDetails\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\EventProgressDetails\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\EventProgressDetails\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
