...
class TemplateController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\MyExperience\Form\TemplateCreate');
        ...
        if ($post = $this->post(false)) {
         ...
         //      $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/myexperience/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\MyExperience\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            ...
            //    $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/myexperience/template/directory');
            }
            catch (\Exception $e) {
                // failed
