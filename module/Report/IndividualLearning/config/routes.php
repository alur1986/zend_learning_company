                ...
                'child_routes' => [
                    'individual-learning' => [
                        ...
                        'options' => [
                            ...
                            'defaults' => [
                                'controller' => 'Report\IndividualLearning\Controller\Manage',
                                'action' => 'start'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\IndividualLearning\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\IndividualLearning\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
