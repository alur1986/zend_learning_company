            ...
            'report' => [
                'child_routes' => [
                    'xapi-interactions' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/xapi-interactions',
                            'defaults' => [
                                'controller' => 'Report\XAPIInteractions\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\XAPIInteractions\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\XAPIInteractions\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
