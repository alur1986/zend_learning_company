...
class TemplateController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\XAPIInteractions\Form\TemplateCreate');
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                $data['type'] = 'report-xapi-interactions';
         ...
         //      $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/xapi-interactions/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\XAPIInteractions\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            try {
                ...
                return $this->redirect()->toRoute('report/xapi-interactions/template/directory');
            }
            catch (\Exception $e) {
                // failed
