            ...
            'report' => [
                'child_routes' => [
                    'learning-progress-summary' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/learning-progress-summary',
                            'defaults' => [
                                'controller' => 'Report\LearningProgressSummary\Controller\Manage',
                                'action' => 'tools'
                            ]
                        ],
                        'child_routes' => [
                            ...
                            'filter' => [
                                ...
                                'options' => [
                                    'route' => '/filter',
                                    'defaults' => [
                                        'controller' => 'Report\LearningProgressSummary\Controller\Filter',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'template' => [
                                ...
                                'options' => [
                                    'route' => '/template',
                                    'defaults' => [
                                        'controller' => 'Report\LearningProgressSummary\Controller\Template',
                                        'action' => 'directory'
                                    ]
                                ],
                                'child_routes' => [
