...
class TemplateController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        // form
        $form = $this->form('Report\LearningProgressSummary\Form\TemplateCreate');
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                $data['type'] = 'report-learning-progress-summary';
       ...
       //         $this->getResponse()->getHeaders()->addHeader($cookie);
                ...
                return $this->redirect()->toRoute('report/learning-progress-summary/template/update', ['template_id' => $template['template_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Report\LearningProgressSummary\Form\TemplateUpdate');
    ...
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm')) {
            try {
                ...
                return $this->redirect()->toRoute('report/learning-progress-summary/template/directory');
            }
            catch (\Exception $e) {
                // failed
