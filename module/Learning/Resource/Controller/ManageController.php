...
class ManageController extends AbstractActionController
{
    ...
    /**
     * Display ALL resource learning activities
     */
    ...
    /**
     * Create ONE resource learning activity
     */
    public function createAction ()
    {
        $siteId  = $this->params('site_id');
        // form
        $form    = $this->form('Resource\Form\Create');
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                // success
                $message = sprintf($this->translate('The learning activity %s has been created successfully. Please click the "Files" tab to upload resources.'), $activity['title']);
    ...
    /**
     * Display ONE resource learning activity
     */
    ...
    /**
     * Update ONE resource learning activity
     */
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Resource\Form\Update');
        $form->get('plan_id')->setValueOptions($arr);
    ...
    /**
     * Duplicate ONE resource learning activity
     */
    ...
    /**
     * Delete ONE resource learning activity
     */
