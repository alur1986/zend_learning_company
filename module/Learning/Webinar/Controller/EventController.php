...
class EventController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                return $this->redirect()->toRoute('learning/webinar/event/update', ['event_id' => $event['event_id']]);
            }
    ...
    public function deleteAction ()
    {
     ...
     //       $this->getResponse()->getHeaders()->addHeader($cookie);
            ...
            return $this->redirect()->toRoute('learning/webinar/event/directory', ['activity_id' => $activity['activity_id']]);
        }
