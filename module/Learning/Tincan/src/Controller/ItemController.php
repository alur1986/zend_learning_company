...
class ItemController extends AbstractActionController
{
    ...
    /**
     * Display ALL items within the Tincan course
    ...
    public function directoryAction ()
    {
        ...
        $items      = $service->findAllItemsByActivityId($activityId);
        ...
        if (!count($items)) {
	        ...
	        //    $manifestFileName = $courseFilePath . DIRECTORY_SEPARATOR . $scormOptions->getManifestFilename();
                ...
                $message = sprintf($this->translate('Cannot load the items for the learning activity "%s" from the manifest file. Please upload a Tincan compliant course.'), $activity['title']);
    ...
    /**
     * Display ONE item within the Tincan course
     */
    ...
    /**
     * Update ONE item within the Tincan course
     */
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Tincan\Form\ItemUpdate');
    ...
    /**
     * Delete ONE item within the Tincan course
     */
    public function deleteAction ()
    {
        ...
        if ($this->params('confirm') === 'yes') {
            try {
                ...
                return $this->redirect()->toRoute('learning/tincan/course/item/directory', ['activity_id' => $activity['activity_id']]);
            }
            catch (\Exception $e) {
                // failed
