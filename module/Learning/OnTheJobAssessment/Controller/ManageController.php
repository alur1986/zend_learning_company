...
{
    /**
     * Display ALL on-the-job-assessment learning activities
     */
    public function directoryAction ()
    {
        $siteId = $this->params('site_id');
        $activityType = $this->params('activity_type');
    ...
    /**
     * Create ONE on-the-job-assessment learning activity
     */
    public function createAction ()
    {
        $siteId   = $this->params('site_id');
        // form
        $form = $this->form('OnTheJobAssessment\Form\Create');
    ...
    /**
     * Display ONE on-the-job-assessment learning activity
     */
    ...
    /**
     * Update ONE on-the-job-assessment learning activity
     */
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('OnTheJobAssessment\Form\Update');
        $form->get('plan_id')->setValueOptions($arr);
    ...
    /**
     * Duplicate ONE on-the-job-assessment learning activity
     */
    ...
    /**
     * Delete ONE on-the-job-assessment learning activity
     */
