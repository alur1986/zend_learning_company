...
class EventController extends AbstractActionController
{
    ...
    public function createAction ()
    {
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                return $this->redirect()->toRoute('learning/on-the-job-assessment/event/update', ['event_id' => $event['event_id']]);
            }
    ...
    public function updateAction ()
    {
        ...
        $form->populateValues(Stdlib\ObjectUtils::extract($event));
    ...
    public function deleteAction ()
    {
     ...
     //       $this->getResponse()->getHeaders()->addHeader($cookie);
            ...
            return $this->redirect()->toRoute('learning/on-the-job-assessment/event/directory', ['activity_id' => $activity['activity_id']]);
        }
