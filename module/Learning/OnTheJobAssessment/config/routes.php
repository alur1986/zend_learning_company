            ...
            'learning' => [
                'child_routes' => [
                    'on-the-job-assessment' => [
                        ...
                        'may_terminate' => true,
                        'options' => [
                            'route' => '/on-the-job-assessment',
                            'defaults' => [
                                'controller' => 'OnTheJobAssessment\Controller\Manage',
                                'action' => 'directory',
                                'activity_type' => 'on-the-job-assessment'
                            ]
                        ],
                        'child_routes' => [
                            'directory' => [
                            ...
                            'event' => [
                                ...
                                'options' => [
                                    'route' => '/event',
                                    'defaults' => [
                                        'controller' => 'OnTheJobAssessment\Controller\Event',
                                        'action' => 'events'
                                    ]
                                ],
                                'child_routes' => [
                            ...
                            'preview' => [
                                ...
                                'options' => [
                                    ...
                                    'defaults' => [
                                        'controller' => 'OnTheJobAssessment\Controller\Questions',
                                        'action' => 'preview'
                                    ]
                                ]
                            ],
