...
{
/**
     * Display ALL scorm12 learning activities
     */
    public function directoryAction ()
    {
        $siteId = $this->params('site_id');
        $activityType = 'scorm12';
    ...
    /**
     * Create ONE scorm12 learning activity
     */
    public function createAction ()
    {
        $siteId  = $this->params('site_id');
        // form
        $form    = $this->form('Scorm12\Form\Create');
        ...
        if ($post = $this->post(false)) {
            ...
            /*    if ($form->isValid()) {
                ...
                // success
                $message = sprintf($this->translate('The learning activity %s has been created successfully. Please click the "Upload" tab to upload your scorm files'), $activity['title']);
    ...
    /**
     * Display ONE scorm12 learning activity
     */
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('Scorm12\Form\Update');
        $form->get('plan_id')->setValueOptions($arr);
    ...
    /**
     * Duplicate ONE scorm12 learning activity
     */
