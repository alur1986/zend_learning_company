...
class RouteListener
{
    ...
    public function route (MvcEvent $event)
    {
        ...
        // only process this if the route name matches the pattern for scorm12 items
        if (fnmatch('learning/scorm12/*item*', $routeName, FNM_CASEFOLD) && $itemId) {
            /* @var $service \Scorm12\Service\Scorm12Service */
            $service = $serviceManager->get('Scorm12\Service');
