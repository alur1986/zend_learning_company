...
class ManifestFileExists extends AbstractValidator
{
    ...
    protected $messageTemplates = [
        self::FILE_NOT_EXISTS => 'Scorm 1.2 ZIP file does not exists',
        self::MANIFEST_NOT_EXISTS => 'Scorm 1.2 manifest file does not exists',
     ...
     * @var string
     */
    private $manifestFileName = 'imsmanifest.xml';
