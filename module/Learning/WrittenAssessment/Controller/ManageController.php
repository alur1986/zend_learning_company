...
{
    /**
     * Display ALL written assessment learning activities
     */
    public function directoryAction ()
    {
        $siteId = $this->params('site_id');
        $activityType = 'written-assessment';
    ...
    /**
     * Create ONE new written assessment
     */
    public function createAction ()
    {
        $siteId  = $this->params('site_id');
        $form    = $this->form('WrittenAssessment\Form\Create');
        $form->get('site_id')->setValue($siteId);
        $request = $this->getRequest();
        $message = false;

        // get then plans (if any)
        $service = $this->learningService();
        ...
        if ($post = $this->post(false)) {
            try {
                ...
                // success
                $message = sprintf($this->translate('The learning activity %s has been created successfully. Please click the "Assessment" tab to create your assessment.'), $activity['title']);
    ...
    /**
     * Display ONE written assessment details
     */
    ...
    /**
     * Display ALL events in ONE written assessment learning activity
     */
    ...
    public function updateAction ()
    {
        ...
        // create form
        $form = $this->form('WrittenAssessment\Form\Update');
        $form->get('plan_id')->setValueOptions($arr);
    ...
    /**
     * Duplicate ONE written assessment
     */
