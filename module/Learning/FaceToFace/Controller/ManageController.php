...
class ManageController extends AbstractActionController
{
    ...
    /**
     * Display ALL face-to-face learning activities
     */
    ...
    /**
     * Create ONE face-to-face learning activity
     */
    public function createAction ()
    {
        $siteId  = $this->params('site_id');
        // form
        $form     = $this->form('FaceToFace\Form\Create');
            ...
            try {
                ...
                if (isset($post['auto_distribute']) && ($post['auto_distribute'] == 'on' || $post['auto_distribute'] == true)) {
                    ...
                    if (($post['auto_distribute_on_registration'] == 0 || $post['auto_distribute_on_registration'] == false) && ($post['auto_distribute_on_login'] == 0 || $post['auto_distribute_on_login'] == false)) {
                        // if neither auto_distribute_on_registration or auto_distribute_on_login are set to on, force the auto_distributr to fail
    ...
    /**
     * Display ONE face-to-face learning activity
     */
    ...
    /**
     * Display ALL events in ONE face-to-face learning activity
     */
    ...
    public function updateAction ()
    {
        ...
        // form
        $form = $this->form('FaceToFace\Form\Update');
        $form->get('plan_id')->setValueOptions($arr);
        ...
        $form->populateValues(Stdlib\ObjectUtils::extract($activity));
    ...
    /**
     * Get the FaceToFace doctrine service provider
     *
